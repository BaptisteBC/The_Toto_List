...
class Principal(QWidget):
    ...
    def afficherTache(self, id_tache, titre_tache, soustache_id_tache=None):
        ...
        detail.clicked.connect(lambda: self.detail(id_tache, soustache_id_tache, titre_tache))
    ...
    def detail(self, id_tache, soustache_id_tache, titre_tache):
        try :
            Detail(id_tache, soustache_id_tache, titre_tache, self.cnx).exec()
...
class Detail(QDialog):
    def __init__(self, id_tache, soustache_id_tache, titre_tache, cnx):
        super().__init__()
        ...
        self.titre = QLabel(f'Titre : {titre_tache}')
    ...
    def get_details(self):
        if self.soustache_id_tache:
            curseur = self.cnx.cursor()
            curseur.execute(f'SELECT titre_soustache, description_soustache, datecreation_soustache, datefin_soustache,'
                            f'statut_soustache, daterappel_soustache FROM soustaches '
