...
class TodoListApp(QMainWindow):
    def __init__(self, pseudonyme_utilisateur, motdepasse_utilisateur):
        ...
        self.bouton_parametres = QPushButton("Paramètres")
        self.bouton_aide = QPushButton("Aide")
        ...
        layout_barre_laterale.addWidget(self.bouton_parametres)
        layout_barre_laterale.addWidget(self.bouton_aide)
        ...
        self.bouton_parametres.clicked.connect(self.open_settings)
        self.bouton_aide.clicked.connect(self.open_help)
