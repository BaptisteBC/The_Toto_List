...
class TaskServer:
    ...
    def __init__(self, host='localhost', port=12345):
        ...
        self.dbConnection = pymysql.connect(
            host='85.10.235.60',
            user='totodb-admin',  # Remplacez par votre utilisateur MySQL
            password='&TotoDB$IUT!2024%Ad',  # Remplacez par votre mot de passe MySQL
            database='TheTotoDB',  # Nom de votre base de données
            port=50000,
