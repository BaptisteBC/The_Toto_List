...
class FormulaireTache(QWidget):
    ...
    def ChargerListes(self):
        ...
        try:
            ...
            elif "Aucune liste disponible." in resultats_listes[0].values():
                QMessageBox.warning(self, "Attention", f"Aucune liste a été trouvée")
            else:
...
class TodoListApp(QMainWindow):
    ...
    def afficherMenuTache(self, idTache, bouton):
        ...
        actionDetailTache.triggered.connect(lambda: self.detail(idTache, None))
    ...
    def afficherTache(self, id_tache, titre_tache, soustache_id_tache=None):
        ...
        print(id_tache, soustache_id_tache)
